...
CREATE TABLE `aprendizagens_aeej` (
  ...
  CONSTRAINT `FK_etapa_jogo` FOREIGN KEY (`etapa_jogo`, `codigo_jogo`) REFERENCES `etapas_jogo` (`etapa`,`codigo_jogo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_fase_jogo` FOREIGN KEY (`fase_jogo`, `codigo_jogo`) REFERENCES `fases_jogo` (`fase`,`codigo_jogo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_nivel_jogo` FOREIGN KEY (`nivel_jogo`, `codigo_jogo`) REFERENCES `niveis_jogo` (`nivel`,`codigo_jogo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `etapas_jogo` (
  ...
  KEY `codigo_jogo` (`codigo_jogo`),
  KEY `etapas_jogo_ibfk_2` (`nivel`),
  KEY `etapas_jogo_ibfk_3` (`fase`),
  CONSTRAINT `etapas_jogo_ibfk_1` FOREIGN KEY (`codigo_jogo`) REFERENCES `jogos_digitais` (`codigo`),
  CONSTRAINT `etapas_jogo_ibfk_22` FOREIGN KEY (`nivel`, `codigo_jogo`) REFERENCES `niveis_jogo` (`nivel`,`codigo_jogo`),
  CONSTRAINT `etapas_jogo_ibfk_33` FOREIGN KEY (`fase`,`codigo_jogo`) REFERENCES `fases_jogo` (`fase`,`codigo_jogo`),
  constraint `uq_etapas_jogo` UNIQUE (`etapa`,`codigo_jogo`,`nivel`,`fase`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fases_jogo` (
  ...
  CONSTRAINT `fases_jogo_ibfk_2` FOREIGN KEY (`nivel`,`codigo_jogo`) REFERENCES `niveis_jogo` (`nivel`,`codigo_jogo`),
  CONSTRAINT `uq_fases_jogo` UNIQUE (`fase`,`codigo_jogo`,`nivel`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
