...
CREATE TABLE `aprendizagens_aeej` (
  ...
  CONSTRAINT `FK_etapa_jogo` FOREIGN KEY (`etapa_jogo`) REFERENCES `etapas_jogo` (`etapa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_fase_jogo` FOREIGN KEY (`fase_jogo`) REFERENCES `fases_jogo` (`fase`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_nivel_jogo` FOREIGN KEY (`nivel_jogo`) REFERENCES `niveis_jogo` (`nivel`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `etapas_jogo` (
  ...
  CONSTRAINT `etapas_jogo_ibfk_2` FOREIGN KEY (`nivel`) REFERENCES `niveis_jogo` (`nivel`),
  CONSTRAINT `etapas_jogo_ibfk_3` FOREIGN KEY (`fase`) REFERENCES `fases_jogo` (`fase`),
...
CREATE TABLE `fases_jogo` (
  ...
  CONSTRAINT `fases_jogo_ibfk_2` FOREIGN KEY (`nivel`) REFERENCES `niveis_jogo` (`nivel`),
...
-- Dump completed on 2017-09-10 21:08:54
