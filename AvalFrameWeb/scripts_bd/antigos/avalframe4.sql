...
CREATE TABLE `competencias_aprendizagens` (
  ...
  CONSTRAINT `uq_competencias_aprendizagens` UNIQUE (`codigo_competencia`,`codigo_apredizagem`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `niveis_aprendizagem` (
  ...
  CONSTRAINT `niveis_aprendizagem_ibfk_1` FOREIGN KEY (`codigo_apredizagem`) REFERENCES `aprendizagens` (`codigo`),
  constraint `uq_niveis_aprendizagem` UNIQUE (`nivel`,`codigo_apredizagem`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
