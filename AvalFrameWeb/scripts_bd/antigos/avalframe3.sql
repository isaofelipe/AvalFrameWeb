...
CREATE TABLE `aprendizagens_aeej` (
  ...
  `tipo_operacao` char(1) COLLATE utf8_bin DEFAULT NULL,
  `descritor_operacao` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `valor_padrao` int(3) DEFAULT NULL,
...
CREATE TABLE `aprendizagens_dadosmultimodais` (
  `codigo_aprendizagem` int(3) DEFAULT NULL,
  `codigo_dispositivo` int(3) DEFAULT NULL,
  `codigo_dadomultimodal` int(3) DEFAULT NULL,
...
CREATE TABLE `dados_multimodais` (
  `codigo_dispositivo` int(2) DEFAULT NULL,
  `codigo` int(2) NOT NULL,
  `nome` varchar(30) DEFAULT NULL,
  `codigo_unidade_medida` int(2) DEFAULT NULL,
  PRIMARY KEY (`codigo`),
