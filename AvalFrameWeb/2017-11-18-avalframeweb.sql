...
--
-- Host: 127.0.0.1    Database: avalframeweb
-- ------------------------------------------------------
...
CREATE TABLE `jogadores` (
  ...
  `perfil_do_jogador` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jogadores` VALUES (1,'Joao','M','1991-01-01','1991-05-05',NULL),(2,'Jose','F','1997-01-01','2002-01-01',NULL);
...
-- Dump completed on 2017-11-18 20:25:36
