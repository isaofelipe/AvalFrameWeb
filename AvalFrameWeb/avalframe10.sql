...
-- -----------------------------------------------------
-- Table `avalframeweb`.`historico_registro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `avalframeweb`.`historico_registro` (
    `codigo` INT NOT NULL AUTO_INCREMENT,
    `codigo_jogador` INT(6) NULL,
    `data_inicio_jogo` DATE NULL,
    `hora_inicio_jogo` TIME NULL,
    `codigo_jogo` INT(3) NULL,
    `nivel_jogo` INT(2) NULL,
    `fase_jogo` INT(2) NULL,
    `etapa_jogo` INT(2) NULL,
    `codigo_aeej` INT(3) NULL,
    `tipo_aeej` VARCHAR(1) NULL,
    `valor1` INT(4) NULL,
    `valor2` INT(4) NULL,
    `valor3` INT(4) NULL,
    `data_gravacao` DATE NULL,
    `hora_gravacao` TIME NULL,
...
-- -----------------------------------------------------
-- Table `avalframeweb`.`base_consolidada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `avalframeweb`.`base_consolidada` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `codigo_jogador` INT(3) NULL,
  `data_inicio_jogo` DATE NULL,
  `hora_inicio_jogo` TIME NULL,
  `codigo_jogo` INT(3) NULL,
  `codigo_aprendizagem` INT(3) NULL,
  `tipo_aprendizagem` VARCHAR(1) NULL,
  `valor_aprendizagem` FLOAT NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
