...
class Aeej(models.Model):
    ...
    codigo_jogo = models.ForeignKey('JogosDigitais', models.DO_NOTHING, db_column='codigo_jogo', blank=True, null=True)
...
class AprendizagensDadosmultimodais(models.Model):
    codigo = models.AutoField(primary_key=True)
    codigo_aprendizagem = models.ForeignKey(Aprendizagens, models.DO_NOTHING, db_column='codigo_aprendizagem')
    codigo_dispositivo = models.ForeignKey('DispositivosCaptura', models.DO_NOTHING, db_column='codigo_dispositivo')
    codigo_dadomultimodal = models.ForeignKey('DadosMultimodais', models.DO_NOTHING, db_column='codigo_dadomultimodal')
    tipo_operacao = models.CharField(max_length=1)
    descritor_operacao = models.CharField(max_length=30, blank=True, null=True)
    ...
    class Meta:
        ...
        unique_together = (('codigo_aprendizagem', 'codigo_dispositivo', 'codigo_dadomultimodal'),)
...
class DadosMultimodais(models.Model):
    codigo_dispositivo = models.ForeignKey('DispositivosCaptura', models.DO_NOTHING, db_column='codigo_dispositivo')
    codigo = models.AutoField(primary_key=True)
    nome = models.CharField(unique=True, max_length=30)
    codigo_unidade_medida = models.ForeignKey('UnidadesMedida', models.DO_NOTHING, db_column='codigo_unidade_medida')
