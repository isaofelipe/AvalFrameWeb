# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-07 20:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_aprendizagem', models.CharField(blank=True, max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_aeej', models.CharField(blank=True, max_length=1, null=True)),
                ...
                ('nome_arquivo', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='NiveisCompetenciaAvaliacao',
            fields=[
                ('codigo', models.AutoField(primary_key=True, serialize=False)),
                ('titulo', models.CharField(blank=True, max_length=20, null=True)),
                ('inicio_nivel', models.DecimalField(blank=True, decimal_places=4, max_digits=5, null=True)),
